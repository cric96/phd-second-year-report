...
%
\rev{
In my research project, I have to deal with Cyber-Physical Swarm (CPS), 
...
Cyber-Physical Swarms are spatially tied (each entity belonging to the system has an effect on the other entities in the same environment), 
 they have no fixed size (possibly very large), 
 they are composed of entities that have partial observability of the environment and 
 they exist in stochastic environments.
%
Furthermore, these systems are collocated in the modern IT scenario, and so we have to cope with complex and layered networks.
%
...
So my research goal is to engineer CPS, 
 namely, find a systematic methodology for synthesis and deploy self-organising behaviours in these systems. 
...
Towards this direction, distributed intelligence, flexible middlewares, and ad-hoc
