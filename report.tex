...
%
Swarm robotics, ``swarms" of people (crowd) or, in general, ``swarms" of IoT devices are clearly defined instances of CPSW.

These systems exist in largely unpredictable environments and they have no fixed size (possibly very large).
%
