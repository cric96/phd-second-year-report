...
%
In the article, I discuss the main directions of this integration (\Cref{fig:overview}), which are:
\begin{itemize}
...
\textit{\citefield{domains}{title}} discusses a design abstraction used to
