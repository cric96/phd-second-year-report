...
\begin{itemize}
	\item in \textit{\citefield{roadmap}{title}} I have drafted 
...
\item In \textit{\citefield{rl-middleware}{title}}, 
...
This work can be seen as an extension of the \textit{\citefield{zambonelli2021time}{title}} 
...
%
\item In \textit{\citefield{swarm-clustering}{title}} 
...
\item \textit{\citefield{domains}{title}} considers a design abstraction used to
...
\item For what concern the engineering methodologies, in \textit{\citefield{engineering}{title}}
...
%
\item in \textit{\citefield{scafi-paper}{title}}, I describe ScaFi, 
